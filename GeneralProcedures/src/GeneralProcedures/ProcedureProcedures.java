 ...
 * @throws Exception Ошибка при исполнении Процедуры.
  */
 @OperatorProcedure(State = ImplementationState.NotTested, Title = "Создать Команду",
         ...
         ArgumentCollection args) throws Exception
 {
     ...
     String str = String.format("Начата процедура CommandCreateProcedure(\"%s\")", args.getByIndex(0).get_ArgumentValue());
     //TODO: вывести это тестовое сообщение о начале процедуры - в лог!
     engine.get_OperatorConsole().PrintTextLine(str, EnumDialogConsoleColor.Сообщение);
