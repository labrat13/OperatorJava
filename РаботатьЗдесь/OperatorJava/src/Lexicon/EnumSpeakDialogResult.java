...
/*
 * Это кривой флаговый енум на Java.
 * Других способов попроще создать класс-набор флагов тут не нашлось.
 * Поэтому каждый раз надо создавать объект енума и флаги в него дописывать.
 * 
 * Пример использования:
 * EnumSpeakDialogResult esr = new
 * EnumSpeakDialogResult(EnumSpeakDialogResult.Да | EnumSpeakDialogResult.Нет |
 * EnumSpeakDialogResult.Отмена );
 */
 ...
 */
public final class EnumSpeakDialogResult
{
