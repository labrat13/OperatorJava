...
public enum EnumSettingKey
{
     ...
     */
    IgnoreStartup("IgnoreStartup", "Логическое значение, игнорировать ли команды старта и завершения Оператор из файла настроек и БД при загрузке и завершении Оператора."),
