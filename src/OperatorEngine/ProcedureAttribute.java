 ...
 *         State: Не используется ввиду отсутствия в языке Java атрибутов
 */
 ...
 * @author 1
 */
public class ProcedureAttribute
{
...
//
// /// <summary>
// /// Mark element (assembly, class, method) as a method implementation element
// with specify an implementation stage
// /// </summary>
// /// <remarks>This attribute marks assemblies, classes and functions as usable
// in method execution process.
// /// If assembly, class, function has this attribute, user can view and select
// as method realization.</remarks>
