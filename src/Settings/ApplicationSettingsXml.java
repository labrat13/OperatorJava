 ...
 * Закомментирован, поскольку реализацию неохота писать и она сложнее, чем сейчас требуется.
 * Но класс оставлен в проекте, так как неохота терять уже написанный код - авось потом пригодится.
 * 
 * @author Селяков Павел
 *
 */
...
//     * @throws XMLStreamException 
//     */
//    public void Store(String filename) throws FileNotFoundException, XMLStreamException
//    {
//
